module ethos::game_board_2048 {
    use std::vector;
    
    friend ethos::game_2048;
    #[test_only]
    ...
    struct GameBoard2048 has store, copy, drop{
        packed_spaces: u64,
        score: u64,
    ...
    public(friend) fun default(random: vector<u8>): GameBoard2048 {
    ...
    public(friend) fun move_direction(game_board: &mut GameBoard2048, direction: u64, random: vector<u8>) {
    ...
    public(friend) fun packed_spaces(game_board: &GameBoard2048): &u64 { 
        &game_board.packed_spaces 
    }

    public(friend) fun score(game_board: &GameBoard2048): &u64 { 
        &game_board.score 
    }

    public(friend) fun last_tile(game_board: &GameBoard2048): &vector<u64> {
        &game_board.last_tile
    }

    public(friend) fun top_tile(game_board: &GameBoard2048): &u64 {
        &game_board.top_tile
    }

    public(friend) fun game_over(game_board: &GameBoard2048): &bool {
    ...
    public(friend) fun board_space_at(game_board: &GameBoard2048, row_index: u8, column_index: u8): u64 {
        space_at(game_board.packed_spaces, row_index, column_index)
    }

    public(friend) fun empty_space_positions(game_board: &GameBoard2048, direction: u64): vector<SpacePosition> {
    ...
    public(friend) fun empty_space_count(game_board: &GameBoard2048): u64 {
    ...
    fun move_possible(game_board: &GameBoard2048): bool {
        let rows = ROW_COUNT;
        let columns = COLUMN_COUNT;
    ...
    fun add_new_tile(game_board: &mut GameBoard2048, direction: u64, random: vector<u8>): u64 {
    ...
    #[test_only]
    public fun print_board(board: &GameBoard2048) {        
    ...
    #[test_only]
    fun game_board_matches(game_board: &GameBoard2048, expected_spaces: vector<u64>): bool {
